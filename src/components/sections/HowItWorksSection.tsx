      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mx-auto mb-16">
          <div className="liquid-glass rounded-full px-4 py-1.5 inline-flex items-center gap-2 mb-6">
            <span className="relative z-10 text-sm text-muted-foreground">Simple Process</span>
          ...
          <p className="text-muted-foreground text-lg mt-4 max-w-lg mx-auto text-center">
